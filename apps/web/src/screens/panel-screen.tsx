...
import type { getPanelNotificationFeed } from '@/app/(app)/panel/queries'
...
export type PanelFeed = Awaited<ReturnType<typeof getPanelNotificationFeed>>

export function PanelScreen({ feed, now = new Date() }: { feed: PanelFeed; now?: Date }) {
