...
export function MeasurementsView({ measurements, activeGoals, weightGoal, onSaveMeasurement, onCreateGoal, onAchieveGoal }: {
  ...
  return <div className="flex flex-col gap-4">
    <Card><CardContent><MeasurementForm previousMeasurement={latest ? { measuredAt: latest.measuredAt, weightKg: latest.weightKg, heightCm: latest.heightCm } : null} onSave={onSaveMeasurement} /></CardContent></Card>
    ...
    <div className="flex flex-col gap-2"><p className="text-sm font-medium">Hedef takibi</p><GoalPanel activeGoals={activeGoals} measurements={measurements} onCreateGoal={onCreateGoal} onAchieveGoal={onAchieveGoal} /></div>
  </div>
}
