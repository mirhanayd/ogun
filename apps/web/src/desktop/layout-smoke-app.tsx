...
const clientRows = [
  { id: 'client-1', firstName: 'Deniz', lastName: 'Yılmaz', birthDate: '1992-04-12', status: 'aktif' as const, assignedDietitianId: 'user-1', assignedDietitianName: 'Dyt. Ada Demir', lastMeasurementAt: new Date('2026-08-25T10:00:00+03:00'), lastMeasurementWeightKg: '77.20', lastAppointmentAt: new Date('2026-08-28T10:00:00+03:00'), lastAppointmentStatus: 'geldi' as const, createdAt: new Date('2026-08-01') },
  { id: 'client-2', firstName: 'Selin', lastName: 'Kaya', birthDate: '1986-09-21', status: 'aktif' as const, assignedDietitianId: 'user-2', assignedDietitianName: 'Dyt. Ece Kaya', lastMeasurementAt: new Date('2026-08-22T10:00:00+03:00'), lastMeasurementWeightKg: '64.80', lastAppointmentAt: new Date('2026-08-27T10:00:00+03:00'), lastAppointmentStatus: 'planlandı' as const, createdAt: new Date('2026-08-04') },
]
...
function Screen({ route }: { route: string }) {
  if (route === '/danisanlar') return <ClientsScreen role="owner"><ClientsTableView result={{ rows: clientRows, total: clientRows.length, page: 1, pageSize: 20 }} dietitians={[{ id: 'user-1', name: 'Dyt. Ada Demir' }, { id: 'user-2', name: 'Dyt. Ece Kaya' }]} role="owner" filters={{ search: '', status: '', assignedDietitianId: '' }} onNavigate={() => undefined} onArchive={async () => ({ success: true })} onAssign={async () => ({ success: true })} /></ClientsScreen>
