...
const nutrientSeeds: Omit<NutrientSeed, 'displayOrder'>[] = [
  ...
  {
    code: 'F16D0',
    nameTr: 'Palmitik asit',
    nameEn: 'Palmitic acid',
    unit: 'g',
    category: 'yağ_asidi',
    isCore: false,
  },
  ...
  {
    code: 'F18D3N3',
    nameTr: 'Alfa-linolenik asit (omega-3)',
  ...
  {
    code: 'PANTAC',
    nameTr: 'B5 vitamini (Pantotenik asit)',
